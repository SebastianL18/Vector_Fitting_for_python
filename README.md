...
* **"errplot"**: _type=bool_. Includes logarithmic error graph in the results.
...
This repository also includes a sample code with some test cases for _vectfit3.py_ module. Some examples requires **pandas** module and external .csv files with input data to run successfully. Cases included are:
